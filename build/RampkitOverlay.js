...
function showRampkitOverlay(opts) {
    Logger_1.Logger.verbose("showRampkitOverlay called");
    if (sibling)
...
function preloadRampkitOverlay(opts) {
    ...
    try {
        ...
        const HiddenPreloader = () => ((0, jsx_runtime_1.jsx)(react_native_1.View, { pointerEvents: "none", style: {
                ...
                top: -1000,
                left: -1000,
            }, children: (0, jsx_runtime_1.jsx)(react_native_webview_1.WebView, { originWhitelist: ["*"], source: { html: docs[0] || "<html></html>" }, injectedJavaScriptBeforeContentLoaded: exports.injectedHardening + exports.injectedButtonAnimations, injectedJavaScript: exports.injectedNoSelect + exports.injectedVarsHandler + exports.injectedButtonAnimations + exports.injectedTemplateResolver, automaticallyAdjustContentInsets: false, contentInsetAdjustmentBehavior: "never", bounces: false, scrollEnabled: false, allowsInlineMediaPlayback: true, mediaPlaybackRequiresUserAction: false, cacheEnabled: true, hideKeyboardAccessoryView: true }) }));
...
function buildHtmlDocument(screen, variables, requiredScripts, rampkitContext, components) {
    ...
    let html = extractBodyContent((0, ComponentExpander_1.expandHTML)(screen.html || "", components));
    const js = screen.js || "";
...
function Overlay(props) {
    ...
    const processPendingActions = (screenIndex) => {
        ...
        for (const action of actions) {
            try {
                ...
                Logger_1.Logger.warn('Error executing pending action:', e);
            }
        }
        // Clear the queue
        pendingActionsRef.current[screenIndex] = [];
    ...
    react_1.default.useEffect(() => {
        ...
        if (initialScreen) {
            EventManager_1.eventManager.setCurrentScreen(initialScreen.label || "");
        }
    }, []);
    ...
    const navigateToIndex = (nextIndex, animation = "fade") => {
        ...
        EventManager_1.eventManager.setCurrentScreen(toScreenName);
                        ...
                        if (window.__rampkitLottieAnimations) {
                          window.__rampkitLottieAnimations.forEach(function(anim) {
                            if (anim && anim.pause) anim.pause();
                                ...
                                Logger_1.Logger.warn("WebView error:", e.nativeEvent);
                            } }) }, props.screens[i].id));
